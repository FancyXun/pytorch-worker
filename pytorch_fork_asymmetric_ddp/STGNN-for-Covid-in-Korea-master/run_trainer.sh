...
export EPOCHS="${EPOCHS:-}" # optional: override json epochs, e.g. EPOCHS=5
export LOG_INTERVAL="${LOG_INTERVAL:-0}"
export SAVE_EVERY_EPOCHS="${SAVE_EVERY_EPOCHS:-0}"
...
export TORCH_DDP_TRAINER_RANK="${TORCH_DDP_TRAINER_RANK:-1}"
...
echo "[stgnn/trainer] MASTER_ADDR=$MASTER_ADDR MASTER_PORT=$MASTER_PORT RANK=$RANK TRAINER_RANK=$TORCH_DDP_TRAINER_RANK IFACE=$GLOO_SOCKET_IFNAME INIT_TIMEOUT_SEC=$INIT_TIMEOUT_SEC"
