"""
Stage2 driver: does not modify ``rpc_remote_training`` (v1); uses ``rpc_remote_training_v2.worker_ops`` RPC targets.
"""
...
import rpc_remote_training_v2.worker_ops as worker_ops
...
class Stage2Trainer:
    ...
    def start_rpc(self) -> None:
        ...
        print(
            f"[rpc_remote_training_v2 driver] rendezvous MASTER_ADDR={self._master_addr!r} MASTER_PORT={self._master_port}",
            flush=True,
        )
